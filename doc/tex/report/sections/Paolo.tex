...
\subsubsection{Plant}
Un'altra parte fondamentale del mio lavoro è stata la modellazione dei vari tipi di piante: sono partito definendo un \texttt{trait Plant} che estende \textit{Troop} e modella il comportamento comune tra le varie piante.
Ho poi creato i vari tipi di piante creando delle classi che estendono \textit{Plant}.

A questo punto mi sono accorto che tutte le piante che sparano hanno lo stesso comportamente, l'unica cosa che cambia è il bullet che sparano.
Ogni tipo di pianta può essere quindi identificata dal rispettivo bullet.

Ho cercato di migliorare il design, provando a renderlo il più riusabile possibile: per fare ciò ho tentato vari approcci, dall'utilizzo di classi astratte alla delegazione, ognuno dei quali presentava vantaggi e svantaggi.
