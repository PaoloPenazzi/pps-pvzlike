...
libraryDependencies ++= Seq(
  ...
  "org.junit.jupiter" % "junit-jupiter" % "6.1.1" % Test, // aggregator of junit-jupiter-api and junit-jupiter-engine (runtime)
  "org.junit.jupiter" % "junit-jupiter-engine" % "6.1.1" % Test, // for org.junit.platform
  "org.junit.vintage" % "junit-vintage-engine" % "6.1.1" % Test,
