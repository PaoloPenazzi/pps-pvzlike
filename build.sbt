...
libraryDependencies ++= Seq(
  ...
  "org.junit.jupiter" % "junit-jupiter" % "5.13.2" % Test, // aggregator of junit-jupiter-api and junit-jupiter-engine (runtime)
  "org.junit.jupiter" % "junit-jupiter-engine" % "5.13.2" % Test, // for org.junit.platform
  "org.junit.vintage" % "junit-vintage-engine" % "5.13.2" % Test,
